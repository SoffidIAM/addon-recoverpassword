...
@Depends ({com.soffid.iam.addons.passrecover.common.DefaultQuestion.class,
...
public abstract class DefaultQuestionEntity {
	...
	@Nullable
	public com.soffid.iam.addons.passrecover.model.UserAnswerEntity answerToQuestion;
